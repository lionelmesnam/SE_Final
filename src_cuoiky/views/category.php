	...
	<div class="box-container">
		...
		?>
				<form action="" method="post" class="box">
					...
					<a href="quick_view.php?id=<?= $product['id']; ?>" class="fas fa-eye"></a>
		...
		if ($categoryy) {
			echo '<p class="empty">Hiện chưa có sản phẩm theo danh mục!</p>';
		}
		?>
